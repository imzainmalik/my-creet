        ...
        <div class="container">
            <div class="row justify-content-center text-center mb-sm">
                <div class="col-lg-8 py-5">
                    <h2 class="mb-0 font-montserrat"><i class="bi bi-speedometer2 mr-2"></i> {{ trans('admin.dashboard') }}
                    </h2>
                    ...
                    <div class="content">
                        <div class="row">
                            <div class="col-lg-4 mb-2">
                                <div class="card">
                                    <div class="card-body overflow-hidden position-relative">
                                        <h4><i class="fas fa-hand-holding-usd mr-2 text-primary icon-dashboard"></i>
                                            {{ Helper::amountFormatDecimal($earningNetUser) }}</h4>
                                        <small>{{ trans('admin.earnings_net') }}</small>

                                        <span class="icon-wrap icon--dashboard"><i
                            ...
                            <div class="col-lg-4 mb-2">
                                ...
                                <div class="card">
                                    <div class="card-body overflow-hidden position-relative">
                                        <h4><i class="fas fa-wallet mr-2 text-primary icon-dashboard"></i>
                                            {{ Helper::amountFormatDecimal(auth()->user()->balance) }}</h4>
                                        <small>{{ trans('general.balance') }}
                                            @if (auth()->user()->balance >= $settings->amount_min_withdrawal)
                                                <a href="{{ url('settings/withdrawals') }}" class="link-border">
                                                    {{ trans('general.make_withdrawal') }}</a>
                                            @endif
                                        </small>
                            ...
                            <div class="col-lg-4 mb-2">
                                <div class="card">
                                    <div class="card-body overflow-hidden position-relative">
                                        <h4><i class="bi-arrow-repeat mr-2 text-primary icon-dashboard-2"></i>
                                            {{ Helper::amountFormatDecimal($earningNetSubscriptions) }}</h4>
                            ...
                            <div class="col-lg-4 mb-2">
                                <div class="card">
                                    <div class="card-body overflow-hidden position-relative">
                                        <h4><i class="bi-coin mr-2 text-primary icon-dashboard-2"></i>
                                            {{ Helper::amountFormatDecimal($earningNetTips) }}</h4>
                            ...
                            <div class="col-lg-4 mb-2">
                                <div class="card">
                                    <div class="card-body overflow-hidden position-relative">
                                        <h4><i class="bi-lock mr-2 text-primary icon-dashboard-2"></i>
                                            {{ Helper::amountFormatDecimal($earningNetPPV) }}</h4>
                            ...
                            <div class="col-lg-4 mb-2">
                                <div class="card">
                                    <div class="card-body overflow-hidden position-relative">
                                        <h6
                                            class="{{ $stat_revenue_today > 0 ? 'text-success' : 'text-danger' }} text-revenue">
                                            ...
                                            <small class="float-right ml-2">
                                                <i class="bi bi-question-circle text-muted" data-toggle="tooltip"
                                                    data-placement="top"
                                                    title="{{ trans('general.compared_yesterday') }}"></i>
                                            </small>
                            ...
                            <div class="col-lg-4 mb-2">
                                <div class="card">
                                    <div class="card-body overflow-hidden position-relative">
                                        <h6
                                            class="{{ $stat_revenue_week > 0 ? 'text-success' : 'text-danger' }} text-revenue">
                                            {{ Helper::amountFormatDecimal($stat_revenue_week) }}
                                            <small class="float-right ml-2">
                                                <i class="bi bi-question-circle text-muted" data-toggle="tooltip"
                                                    data-placement="top"
                                                    title="{{ trans('general.compared_last_week') }}"></i>
                                            </small>
                            ...
                            <div class="col-lg-4 mb-2">
                                <div class="card">
                                    <div class="card-body overflow-hidden position-relative">
                                        <h6
                                            class="{{ $stat_revenue_month > 0 ? 'text-success' : 'text-danger' }} text-revenue">
                                            {{ Helper::amountFormatDecimal($stat_revenue_month) }}
                                            <small class="float-right ml-2">
                                                <i class="bi bi-question-circle text-muted" data-toggle="tooltip"
                                                    data-placement="top"
                                                    title="{{ trans('general.compared_last_month') }}"></i>
                                            </small>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-lg-flex d-block justify-content-between align-items-center mb-4">
                                            ...
                                            <select class="custom-select mb-4 mb-lg-0 w-auto d-block filterEarnings">
                                                <option selected="" value="month">{{ __('general.this_month') }}
                                                </option>
                                        ...
                                        <div class="d-block position-relative" style="height: 350px">
                                            <div class="blocked display-none" id="loadChart">
                                                <span
                                                    class="d-flex justify-content-center align-items-center text-center w-100 h-100">
                                                    <i class="spinner-border spinner-border-sm mr-2 text-primary"></i>
                                                    {{ __('general.loading') }}
                                                </span>
                                            </div>
    ...
    <script type="text/javascript">
                    ...
                    yAxes: [{
                        ticks: {
                            ...
                            callback: function(value, index, values) {
                                return '@if ($settings->currency_position == 'left'){{ $settings->currency_symbol }}@elseif ($settings->currency_position == 'left_space'){{ $settings->currency_symbol }} @endif' +
                                    value +
                                    '@if ($settings->currency_position == 'right'){{ $settings->currency_symbol }}@elseif ($settings->currency_position == 'right_space'){{ ' ' . $settings->currency_symbol }}@endif';
                            }
                        }
                    }],
                    xAxes: [{
        ...
        $(document).on('change', '.filterEarnings', function(e) {
            ...
            $.ajax({
                ...
                $('.popout').addClass('popout-error').html(error_reload_page).slideDown('500').delay('5000')
                    .slideUp('500');
                $('#loadChart').hide();
            });
