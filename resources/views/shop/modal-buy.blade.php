                    ...
                    <div class="card-body px-lg-5 py-lg-5 position-relative">
                        ...
                        <form method="post" action="{{ url('buy/now/product') }}" id="shopProductForm">
                            ...
                            <div class="custom-control custom-radio mb-3">
                                <input name="payment_gateway_buy"
                                    @if (Helper::userWallet('balance') == 0) disabled @else checked @endif value="wallet"
                                    id="buy_radio0" class="custom-control-input" type="radio">
                            ...
                            @if ($product->type == 'custom')
                                <div class="form-group mb-2">
                                    <textarea class="form-control textareaAutoSize" name="description_custom_content" id="descriptionCustomContent"
                                        placeholder="{{ __('general.description_custom_content') }}" rows="4"></textarea>
                                </div>

                                <div class="alert alert-warning" role="alert">
                                    <i class="bi-exclamation-triangle mr-2"></i>
                                    {{ __('general.alert_buy_custom_content') }}
                                </div>
                            @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-4">
                                            ...
                                            <input class="form-control" name="phone"
                                                placeholder="{{ trans('general.phone') }}" type="tel">
                                        </div>
                                    </div><!-- ./col-md-6 -->
                            ...
                            @if (auth()->user()->isTaxable()->count() ||
                                    ($product->shipping_fee != 0.0 && $product->country_free_shipping != auth()->user()->countries_id))
                                <ul class="list-group list-group-flush border-dashed-radius">
                                    ...
                                    @if ($product->shipping_fee != 0.0 && $product->country_free_shipping != auth()->user()->countries_id)
                                        <li class="list-group-item py-1 list-taxes">
                                            <div class="row">
                                                <div class="col">
                                    ...
                                    <li class="list-group-item py-1 list-taxes">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <small class="totalPPV font-weight-bold">
                                                    {{ Helper::calculateProductPriceOnStore($product->price, $product->country_free_shipping != auth()->user()->countries_id ? $product->shipping_fee : 0.0) }}
                                                </small>
                                            </div>
                                        </div>
                                    </li>
                            ...
                            <div class="text-center">
                                <button type="submit" @if (Helper::userWallet('balance') == 0) disabled @endif
                                ...
                                <div class="w-100 mt-2">
                                    <a href="#" class="btn e-none p-0"
                                        data-dismiss="modal">{{ trans('admin.cancel') }}</a>
                                </div>
                            </div>
                        </form>
                    </div>
