                ...
                <div class="col-md-5">
                    ...
                    <div class="card rounded-large shadow-large card-border-0">
                        ...
                        <div class="card-body">
                            ...
                            @if (
                                (auth()->check() && auth()->id() != $product->user()->id && !$verifyPurchaseUser) ||
                                    (auth()->check() &&
                                ...
                                <button class="btn btn-1 btn-primary btn-block mt-4"
                                    @if ($product->quantity == 0 && $product->type == 'physical') disabled @endif type="button" data-toggle="modal"
                            ...
                            @elseif ($product->type == 'custom')
                                <div class="w-100 d-block mt-4">
                                    ...
                                    {{ trans_choice('general.days', $product->delivery_time) }})
                                </div>
                            @else
                                ...
                                @if ($product->shipping_fee != 0.0)
                                    <div class="w-100 d-block mt-4">
                                        ...
                                        @if ($product->country_free_shipping)
                                            <small><em>({{ __('general.free_shipping') }}
                                                    {{ $product->country()->country_name }})</em></small>
                                        @endif
                                    </div>
                                @else
                                    <div class="w-100 d-block mt-4">
            ...
            <div class="modal fade modalReport" id="reportItem" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-danger modal-sm">
                    <div class="modal-content">
                        ...
                        <!-- form start -->
                        <form method="POST" action="{{ url('report/item', $product->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="reason" class="form-control custom-select">
                                        @if ($verifyPurchaseUser && $product->type != 'digital')
                                            <option value="item_not_received">{{ trans('general.item_not_received') }}
                                            </option>
                                        @endif
                                        ...
                                        <option value="violent_sexual">{{ trans('admin.violent_sexual_content') }}
                                        </option>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-xs btn-white sendReport ml-auto"><i></i>
                                    {{ trans('general.report_item') }}</button>
                            </div>
                        </form>
                    </div><!-- Modal content -->
                </div><!-- Modal dialog -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <h4 class="font-weight-light">{{ __('general.other_items_of') }}
