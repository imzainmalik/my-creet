            ...
            <div class="row">
                <div class="col-lg-5 second">
                    ...
                    <p>
                        ...
                        <a class="btn btn-lg btn-main btn-outline-light btn-w px-4 toggleRegister btn-arrow"
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="text-center">
                        <img src="{{ url('img', $settings->img_1) }}" class="img-center img-fluid" width="120">
                ...
                <div class="col-lg-4">
                    <div class="text-center">
                        <img src="{{ url('img', $settings->img_2) }}" class="img-center img-fluid" width="120">
                ...
                <div class="col-lg-4">
                    <div class="text-center">
                        <img src="{{ url('img', $settings->img_3) }}" class="img-center img-fluid" width="120">
                    ...
                    <div class="row">
                        ...
                        @if ($usersTotal > $users->total())
                            <div class="w-100 mb-3 text-center">
                                <a href="{{ url('creators') }}"
                                    class="float-right link-border">{{ trans('general.view_all_creators') }} <small
                            ...
                            <div>
                                <h3 class="mb-0">
                                    @if ($settings->currency_position == 'left')
                                        ...
                                        @endif{!! Helper::formatNumbersStats(Transactions::whereApproved('1')->sum('earning_net_user')) !!}@if ($settings->currency_position == 'right')
                                            {{ $settings->currency_symbol }}
                                        @endif
                                </h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label for="rangeMonthlySubscription"
                            class="w-100">{{ __('general.monthly_subscription_price') }}
                            <span class="float-right">
                    ...
                    <div class="col-md-12 text-center mt-4">
                        <h3 class="font-weight-light">{{ trans('general.earnings_simulator_subtitle_2') }}
                            <span class="font-weight-bold"><span id="estimatedEarn"></span>
                                <small>{{ $settings->currency_code }}</small></span>
                        ...
                        @if ($settings->fee_commission != 0)
                            <small class="w-100 d-block">*
                                {{ trans('general.include_platform_fee', ['percentage' => $settings->fee_commission]) }}</small>
                        @endif
                    </div>
                </div>
            </div>
