                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            <form method="POST" action="{{ url('contact') }}">
                                        ...
                                        <div class="form-group mb-3">
                                            <div class="input-group input-group-alternative">
                                                ...
                                                <input class="form-control" required
                                                    ...
                                                    placeholder="{{ trans('auth.full_name') }}" name="full_name"
                                                    type="text">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input name="subject" required type="text" value="{{ old('subject') }}"
                                            class="form-control" placeholder="{{ trans('general.subject') }}">
                                    </div>
                                </div>
                                        ...
                                        <label class="custom-control-label" for=" customCheckLogin">
                                            <span>{{ trans('general.i_agree_with') }}
                                                <a href="{{ $settings->link_terms }}"
                                                    target="_blank">{{ trans('admin.terms_conditions') }}</a>
                                                {{ trans('general.and') }} <a href="{{ $settings->link_privacy }}"
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary my-4 w-100">{{ trans('auth.send') }} <i
                            ...
                            @if ($settings->captcha_contact == 'on')
                                <small class="btn-block text-center">{{ trans('auth.protected_recaptcha') }}
                                    <a href="https://policies.google.com/privacy"
                                        ...
                                        target="_blank">{{ trans('general.terms') }}</a>
                                </small>
                            @endif
                        </div>
                    </div>
