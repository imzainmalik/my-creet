                ...
                <div class="@if ($blogs->count() == 0) col-md-12 @else col-md-8 @endif py-5">
                    <div class="row no-gutters border rounded flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                        <div class="card-cover w-100 img-post"
                            style="background: @if ($response->image != '') url({{ Helper::getFile(config('path.admin') . $response->image) }}) @endif #505050 no-repeat center center; background-size: cover; ">
                        </div>
                        <div class="col p-4 d-flex flex-column position-static">
                            <small class="d-inline-block mb-2">{{ trans('general.by') }} {{ $response->user()->name }}
                            </small>
                                            ...
                                            <div class="media-body">
                                                <h5 class="media-heading mb-1">
                                                    ...
                                                    <p class="text-white font-weight-light">
                                                        {{ Str::limit(strip_tags($response->content), 60, '...') }}</p>
                                                </h5>
                                            </div>
                                        </div>
                                    </li>
