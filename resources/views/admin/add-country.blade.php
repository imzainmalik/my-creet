                    ...
                    <div class="card-body p-lg-5">
                        ...
                        <form method="post" action="{{ url('panel/admin/countries/add') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input value="{{ old('iso_code') }}" name="iso_code" type="text"
                                        class="form-control">
                                    <small class="d-block">{{ __('general.iso_code_country') }} <a
                                            href="https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2" target="_blank">(ISO
                                            3166-1 alpha-2) <i class="bi-box-arrow-up-right ms-1"></i></a></small>
                                </div>
                            </div>
